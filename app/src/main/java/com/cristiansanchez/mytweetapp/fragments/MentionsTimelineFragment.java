...
/**
 * Created by kristianss27 on 11/5/16.
 */
public class MentionsTimelineFragment extends Fragment implements TweetAdapter.AdapterListener,ComposeTweetFragment.ComposeTweeDialogListener,ReplyTweetFragment.ReplyTweetDialogListener {
    private static final String TAG = "MentionsTimeline";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup parent, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_mentions_list, parent, false);
        return v;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        btnCompose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                composeTweetFragment.setTargetFragment(MentionsTimelineFragment.this, 300);
