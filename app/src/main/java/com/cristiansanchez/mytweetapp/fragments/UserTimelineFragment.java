 ...
 */
public class UserTimelineFragment extends Fragment implements TweetAdapter.AdapterListener,ReplyTweetFragment.ReplyTweetDialogListener {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof UserInfoActivity) {
            this.listener = (UserInfoActivity) context;
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup parent, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_user_timeline, parent, false);
        return v;
    }
